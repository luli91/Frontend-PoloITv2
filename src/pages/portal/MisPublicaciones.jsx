...
import { getMisPublicaciones } from "../../redux/slices/publicacionesSlice";
...
export default function MisPublicaciones() {
    ...
    const { misPublicaciones, loading, error } = useSelector(state => state.publicaciones);

    useEffect(() => {
        dispatch(getMisPublicaciones());
    }, [dispatch]);
    ...
    return (
        <div className="p-4 max-w-5xl mx-auto">
            ...
            {loading ? (
                ...
                <DataTable
                    value={Array.isArray(misPublicaciones) ? misPublicaciones : []}
                    paginator
                    rows={10}
                    scrollable
                    scrollHeight="400px"
